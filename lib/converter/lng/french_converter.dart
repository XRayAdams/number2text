  ...
  String convert(int input) {
    ...
    if (input < 100) {
      ...
      if (ten == 7) {
        ...
        return "soixante-${_ones[10 + unit]}";
      }
      if (ten == 9) {
        return "quatre-vingt-${_ones[10 + unit]}";
      }
      if (ten == 8) {
        return "quatre-vingt-${_ones[unit]}";
      }
      if (unit == 1) {
    ...
    if (input < 1000) {
      ...
      if (hundred == 1) {
        ...
        hundredsStr = (remainder == 0) ? "${_ones[hundred]} cents" : "${_ones[hundred]} cent";
      }
